...
| `route_short_name_display` | Enum | Optional | Indicates when `route_short_name` should be displayed. If multiple of `trip_short_name`, `route_short_name`, and `route_long_name` are optional, applications may pick a string purely based on space constraints. If empty, applications should display `route_short_name`.<br><br>**Enum:**<br>`1` - The string must always be displayed. It is necessary to identify the transport. This string would be displayed on a physical departure board. For example, `IC 67` or `RE5`.<br>`2` - The string should be displayed if there is enough space, but the transport can usually be identified without it. This string might be displayed on some physical departure boards. For example, `Kyiv Express` or `2342`.<br>`3` - The string is a detail that is not usually used to identify the transport. It is not usually displayed on departure boards, but might occur in route maps or official route documentation. For example, `29`, the German ICE route number.   |
| `route_long_name_display`  | Enum | Optional | Indicates when `route_long_name` should be displayed. If multiple of `trip_short_name`, `route_short_name`, and `route_long_name` are optional, applications may pick a string purely based on space constraints. If empty, applications should not display `route_long_name`.<br><br>**Enum:**<br>`1` - The string must always be displayed. It is necessary to identify the transport. This string would be displayed on a physical departure board. For example, `IC 67` or `RE5`.<br>`2` - The string should be displayed if there is enough space, but the transport can usually be identified without it. This string might be displayed on some physical departure boards. For example, `Kyiv Express` or `2342`.<br>`3` - The string is a detail that is not usually used to identify the transport. It is not usually displayed on departure boards, but might occur in route maps or official route documentation. For example, `29`, the German ICE route number. |
...
| `trip_short_name_display` | Enum | Optional | Indicates when `trip_short_name` should be displayed. If multiple of `trip_short_name`, `route_short_name`, and `route_long_name` are optional, applications may pick a string purely based on space constraints. If empty, applications may display `trip_short_name`.<br><br>**Enum:**<br>`1` - The string must always be displayed. It is necessary to identify the transport. This string would be displayed on a physical departure board. For example, `IC 67` or `RE5`.<br>`2` - The string should be displayed if there is enough space, but the transport can usually be identified without it. This string might be displayed on some physical departure boards. For example, `Kyiv Express` or `2342`.<br>`3` - The string is a detail that is not usually used to identify the transport. It is not usually displayed on departure boards, but might occur in route maps or official route documentation. For example, `29`, the German ICE route number. |

Right — the enum descriptions should be incorporated directly into the field's **Description** cell, rather than separated into a separate enum table. In the style of the GTFS reference, I'd format it like this:
