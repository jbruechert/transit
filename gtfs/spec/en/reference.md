...
| `reservation_availability` | Enum | Optional | Indicates whether a reservation is required in addition to a valid ticket on this trip.<br><br>Valid options are:<br>`0` or empty - No reservation information is available.<br>`1` - A reservation is required in addition to a valid ticket on this trip.<br>`2` - A reservation is recommended to get a seat on this trip.<br>`3` - Reservations are available but optional.<br>`4` - The trip cannot be reserved. |
| `air_conditioning` | Enum | Optional | Indicates whether the vehicle has air conditioning.<br><br>Valid options are:<br>`0` or empty - No information about air conditioning is available.<br>`1` - The vehicle has air conditioning.<br>`2` - The vehicle does not have air conditioning.  |
| `toilet` | Enum | Optional | Indicates whether the vehicle features a toilet.<br><br>Valid options are:<br>`0` or empty - No information about a toilet is available.<br>`1` - The vehicle features a toilet.<br>`2` - The vehicle does not feature a toilet. |
